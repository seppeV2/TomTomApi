...
def initialise_map(api_key=api_key, location=location_brussel, zoom=14, style = "main"):
    """
...
print('https://api.tomtom.com/origindestination/1/analysis/selected-link?key={'+api_key+'}')
